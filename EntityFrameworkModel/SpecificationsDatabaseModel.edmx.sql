...
-- --------------------------------------------------
-- Date Created: 04/02/2022 09:23:45
...
IF OBJECT_ID(N'[dbo].[FK_CustomOrderMotors_VoltageType]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CustomOrderMotors] DROP CONSTRAINT [FK_CustomOrderMotors_VoltageType];
GO
...
IF OBJECT_ID(N'[dbo].[FK_Motor_VoltageType]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[TemplateMotors] DROP CONSTRAINT [FK_Motor_VoltageType];
GO
...
ALTER TABLE [dbo].[CustomOrderMotors]
ADD CONSTRAINT [FK_CustomOrderMotors_VoltageType]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_CustomOrderMotors_VoltageType'
CREATE INDEX [IX_FK_CustomOrderMotors_VoltageType]
