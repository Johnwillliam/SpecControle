...
IF OBJECT_ID(N'[dbo].[FK_CustomOrderMotors_VoltageTypes]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CustomOrderMotors] DROP CONSTRAINT [FK_CustomOrderMotors_VoltageTypes];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_CustomOrderVentilators_VentilatorType]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CustomOrderVentilators] DROP CONSTRAINT [FK_CustomOrderVentilators_VentilatorType];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_TemplateMotors_VoltageTypes]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[TemplateMotors] DROP CONSTRAINT [FK_TemplateMotors_VoltageTypes];
GO
...
GO
IF OBJECT_ID(N'[dbo].[VoltageTypes]', 'U') IS NOT NULL
    DROP TABLE [dbo].[VoltageTypes];
GO
...
-- Creating foreign key on [VoltageTypeID] in table 'CustomOrderMotors'
ALTER TABLE [dbo].[CustomOrderMotors]
ADD CONSTRAINT [FK_CustomOrderMotors_VoltageTypes]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_CustomOrderMotors_VoltageTypes'
CREATE INDEX [IX_FK_CustomOrderMotors_VoltageTypes]
ON [dbo].[CustomOrderMotors]
    ([VoltageTypeID]);
GO
...
ALTER TABLE [dbo].[CustomOrderVentilators]
ADD CONSTRAINT [FK_CustomOrderVentilators_VentilatorType]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_CustomOrderVentilators_VentilatorType'
CREATE INDEX [IX_FK_CustomOrderVentilators_VentilatorType]
ON [dbo].[CustomOrderVentilators]
    ([VentilatorTypeID]);
GO
...
-- Creating foreign key on [VoltageTypeID] in table 'TemplateMotors'
ALTER TABLE [dbo].[TemplateMotors]
ADD CONSTRAINT [FK_TemplateMotors_VoltageTypes]
    FOREIGN KEY ([VoltageTypeID])
    REFERENCES [dbo].[VoltageTypes]
        ([ID])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_TemplateMotors_VoltageTypes'
CREATE INDEX [IX_FK_TemplateMotors_VoltageTypes]
ON [dbo].[TemplateMotors]
    ([VoltageTypeID]);
GO
